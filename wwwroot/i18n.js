...
const i18n = {
    ...
    en: {
        ...
        dict: {
            ...
            "price_mini_amount": "3,000,000",
            "price_mini_period": "One-time Lifetime License",
            "price_mini_strike": "5,000,000",
            ...
            "a3": "After acquiring the 79 Million Toman software license, cloud server hosting and maintenance fees are billed in cycles. You can choose to pay monthly, quarterly, semi-annually, or annually with progressive discounts.",
            "q4": "Are there any hidden fees in the GoldEx Mini version?",
            "a4": "No. GoldEx Mini is designed as a standalone utility. Once the one-time 3 Million Toman license is purchased, there are no monthly, quarterly, or annual server renewal fees whatsoever.",
    ...
    tr: {
        ...
        dict: {
            ...
            "a3": "79 Milyon Tümen yazılım lisansını aldıktan sonra, bulut sunucu barındırma ve bakım ücretleri dönemler halinde faturalandırılır. Kademeli indirimlerle aylık, üç aylık, altı aylık veya yıllık ödemeyi seçebilirsiniz.",
            "q4": "GoldEx Mini sürümünde herhangi bir gizli ücret var mı?",
            "a4": "Hayır. GoldEx Mini bağımsız bir araç olarak tasarlanmıştır. Tek seferlik 3 Milyon Tümen lisansı satın alındıktan sonra hiçbir aylık, üç aylık veya yıllık sunucu yenileme ücreti yoktur.",
